...
double WMIN;
double WMAX;
double X[MAX_TRAINING_POINTS][MAX_NUM_NEURONS];
...
double ACCURACY;
double ERROR_BOUND;
double PROTOTYPE_VARIANCE;
double OUTPUT_X[MAX_NUM_POINTS][MAX_NUM_NEURONS];
...
"2016","Gneural Network");
   ...
   if(LOAD_NEURAL_NETWORK==OFF){
    ...
    if(OPTIMIZATION_METHOD==BAYESIAN){
      setup_probabilityspace(VERBOSITY);
    }
